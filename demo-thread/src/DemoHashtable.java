...
public class DemoHashtable {
  ...
  public static void main(String[] args) {
    ...
    //    Integer result = nameMap.get("bootcamp");
    //    result = result + 1;  // not synchronized
    //    nameMap.put("bootcamp", result);  // synchronized
    //  }
    // };
    ...
    System.out.println(nameMap2.size());   // 10000
    System.out.println(nameMap2.get("bootcamp"));  // null
  }
}
