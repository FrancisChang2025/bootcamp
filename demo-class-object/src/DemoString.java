...
public class DemoString {
  public static void main(String[] args) {
    // String -> Literal Pool  (數字有限數，String object unlimit)
    ...
    // s = new String("abc");  // s -> declare 'abc'
    // so, at this moment, we got 3 String Objects in memory (hello, hello1, helloworld)
    // new String("world");   // this code is OKAY, even if no Address 孤兒仔，即下行 R17 打印，離開咗就找不回。
    ...
    // Professional words -> Time Complexity and Space Complexity (same above meaning R25)
    ...
    String s5 = "hello???";
    System.out.println(s1 == s5);  // false. "+" -> new String()
    String s6 = "hello???";
    ...
    String s12 = "hellh";  // String is a source code. You can directly "Cmd" + Enter click "String"
    System.out.println(s12.replace('h','x'));  // xellx      Using 'replace'(slow -> for Loop )

    String s13 = s12.substring(1); // ellh

    // replace() -> For Loop   s12.toCharArray();
    // s12.charAt(3);  s12.charAt(4)

    BigDecimal bd = BigDecimal.valueOf(1.0); // add, subtract, multiply, divide
    BigDecimal bd2 = bd.add(BigDecimal.valueOf(1.2));  // 2.2
