...
public class StreamExercise {
  public static void main(String[] args) {
    ...
    // Output: Max: 30
    // Output: Min: 5
    List<Integer> max = max.stream().filter(max -> max.compareTo.ArrayList);
    ...
    wordsList.stream().filter(wordsList.length() > 3).
