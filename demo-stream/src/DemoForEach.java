...
public class DemoForEach {
  public static void main(String[] args) {
    ...
    User user = User.builder().userid("johnwong").email("john@gmail.com")
    ...
    //  User: johnwong,john@gmail.com,2024-10-24
    //  User: peterchan,peter@gmail.com,2024-12-24
    //  User: jessiecheung,jessie@gmail.com,2024-11-24
  }
}